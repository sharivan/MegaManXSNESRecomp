...
[snesrecomp](https://github.com/sharivan/snesrecomp) framework fork. This repo
...
```bash
git clone --recurse-submodules https://github.com/sharivan/MegaManXSNESRecomp.git
cd MegaManXSNESRecomp
bash tools/bootstrap.sh
```

The `snesrecomp/` directory is a pinned submodule from
[sharivan/snesrecomp](https://github.com/sharivan/snesrecomp), and `recomp-ui/`
